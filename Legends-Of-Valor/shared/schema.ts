...
export const VALORPEDIA_ENTRIES: Record<ValorpediaCategory, { id: string; name: string; description: string }[]> = {
  fish: [
    { id: "silver_minnow", name: "Silver Minnow", description: "A tiny common fish found in all waters." },
    { id: "blue_guppy", name: "Blue Guppy", description: "A colorful small fish from calm rivers." },
    { id: "river_dart", name: "River Dart", description: "A swift fish that darts through river currents." },
    { id: "emerald_carp", name: "Emerald Carp", description: "A carp with shimmering emerald-tinted scales." },
    { id: "golden_koi", name: "Golden Koi", description: "A rare golden koi prized by collectors." },
    { id: "frostfin_trout", name: "Frostfin Trout", description: "A trout adapted to icy cold waters." },
    { id: "ember_bass", name: "Ember Bass", description: "A bass with fire-tinged fins." },
    { id: "storm_pike", name: "Storm Pike", description: "A massive pike that appears during storms." },
    { id: "crystal_eel", name: "Crystal Eel", description: "An eel with translucent crystalline scales." },
    { id: "aether_salmon", name: "Aether Salmon", description: "A salmon infused with raw Aether energy." },
    { id: "chrono_catfish", name: "Chrono Catfish", description: "A catfish that exists across multiple time streams." },
    { id: "void_leviathan", name: "Void Leviathan Fry", description: "The young of a legendary void sea creature." },
    { id: "soul_lantern", name: "Soul Lantern Fish", description: "A deep-sea fish that glows with soul energy." },
  ],
  monsters: [
    { id: "stray_rat", name: "Stray Rat", description: "A scrappy rodent lurking in the Capital City." },
    { id: "training_golem", name: "Training Golem", description: "A practice construct used by Capital City guards." },
    { id: "cave_crawler", name: "Cave Crawler", description: "An insectoid creature from the Mountain Caverns." },
    { id: "rock_golem", name: "Rock Golem", description: "A massive golem formed from cavern stone." },
    { id: "crystal_guardian", name: "Crystal Guardian", description: "The fearsome boss of the Mountain Caverns." },
    { id: "cursed_spirit", name: "Cursed Spirit", description: "A dark spirit haunting the Ancient Ruins." },
    { id: "stone_sentinel", name: "Stone Sentinel", description: "An ancient guardian of the ruins." },
    { id: "ruin_wraith", name: "Ruin Wraith", description: "The void-touched boss lurking in the Ancient Ruins." },
    { id: "forest_wolf", name: "Forest Wolf", description: "A nature-element wolf from the Enchanted Forest." },
    { id: "wild_treant", name: "Wild Treant", description: "A living tree creature of the Enchanted Forest." },
    { id: "ancient_ent", name: "Ancient Ent", description: "The ancient guardian of the Enchanted Forest." },
    { id: "lake_sprite", name: "Lake Sprite", description: "A water spirit dancing on Crystal Lake." },
    { id: "water_elemental", name: "Water Elemental", description: "A being of pure water energy at Crystal Lake." },
    { id: "sea_raider", name: "Sea Raider", description: "A pirate raider attacking the Coastal Village." },
    { id: "crab_beast", name: "Crab Beast", description: "A giant crab creature from Coastal Village shores." },
    { id: "gem_golem", name: "Gem Golem", description: "A construct made of precious gems in the Ruby Mines." },
    { id: "mine_crawler", name: "Mine Crawler", description: "A fast creature tunneling through the Ruby Mines." },
    { id: "ruby_wyrm", name: "Ruby Wyrm", description: "The fire-breathing boss of the Ruby Mines." },
    { id: "arena_gladiator", name: "Arena Gladiator", description: "A seasoned fighter in the Battle Arena." },
    { id: "beast_master", name: "Beast Master", description: "A nature-wielding combatant of the Battle Arena." },
    { id: "arena_champion", name: "Arena Champion", description: "The undefeated storm-element champion." },
    { id: "mutant", name: "Mutant", description: "A failed experiment from the Research Lab." },
    { id: "failed_experiment", name: "Failed Experiment", description: "A void-touched creation from the Research Lab." },
    { id: "wild_pet", name: "Wild Pet", description: "An untamed creature at the Pet Training Grounds." },
    { id: "feral_beast", name: "Feral Beast", description: "A wild beast that resists taming." },
    { id: "demon_soldier", name: "Demon Soldier", description: "A dark warrior of the Hell Zone." },
    { id: "hellfire_elemental", name: "Hellfire Elemental", description: "A fire being from the Hell Zone depths." },
    { id: "abyssal_horror", name: "Abyssal Horror", description: "A void nightmare from the Hell Zone." },
    { id: "demon_lord", name: "Demon Lord", description: "The supreme ruler of the Hell Zone." },
    { id: "arcane_sentinel", name: "Arcane Sentinel", description: "A magical guardian of the Mystic Tower." },
    { id: "tower_guardian", name: "Tower Guardian", description: "A light-element protector of the Mystic Tower." },
    { id: "floor_boss", name: "Floor Boss", description: "The Aether-powered final challenge of each tower floor." },
    { id: "thunderstorm_titan", name: "Thunderstorm Titan", description: "A colossal storm creature summoned by thunder weather." },
    { id: "blizzard_wyrm", name: "Blizzard Wyrm", description: "An ice dragon awakened only in blizzard conditions." },
    { id: "fog_phantom", name: "Fog Phantom", description: "A void phantom that emerges from heavy fog." },
    { id: "rain_serpent", name: "Rain Serpent", description: "A water serpent that rises during rainfall." },
  ],
  resources: [
    { id: "iron_ore", name: "Iron Ore", description: "Common metal ore found in mountain caverns." },
    { id: "coal", name: "Coal", description: "Black rock used as fuel and in forging." },
    { id: "silver_ore", name: "Silver Ore", description: "A precious metal with magical conductivity." },
    { id: "gold_ore", name: "Gold Ore", description: "Rare golden ore, prized by smiths everywhere." },
    { id: "wood", name: "Enchanted Wood", description: "Timber infused with ancient forest magic." },
    { id: "herbs", name: "Magical Herbs", description: "Rare herbs with potent alchemical properties." },
    { id: "moonpetal", name: "Moon Petal", description: "A flower petal that blooms only by moonlight." },
    { id: "faerie_dust", name: "Faerie Dust", description: "Shimmering dust shed by forest faeries." },
    { id: "rough_ruby", name: "Rough Ruby", description: "An uncut ruby pulled from deep gem veins." },
    { id: "crystal_shard", name: "Crystal Shard", description: "A sharp fragment of magical crystal." },
    { id: "perfect_ruby", name: "Perfect Ruby", description: "A flawless ruby of exceptional quality." },
    { id: "blood_ruby", name: "Blood Ruby", description: "A crimson ruby pulsing with dark energy." },
    { id: "water_crystal", name: "Water Crystal", description: "A crystal formed from pure magical water." },
    { id: "pearl", name: "Freshwater Pearl", description: "A lustrous pearl from Crystal Lake." },
    { id: "spirit_essence", name: "Spirit Essence", description: "Essence drawn from the spiritual energies of the lake." },
    { id: "driftwood", name: "Driftwood", description: "Wood weathered and carried in by the sea." },
    { id: "sea_salt", name: "Sea Salt", description: "Crystallized salt harvested from ocean waters." },
    { id: "coral", name: "Rare Coral", description: "Brilliant coral from the ocean depths." },
    { id: "sea_gem", name: "Sea Gem", description: "A gem polished by ocean tides over centuries." },
    { id: "ancient_stone", name: "Ancient Stone", description: "Stone blocks from long-fallen civilizations." },
    { id: "relic_fragment", name: "Relic Fragment", description: "A piece of an ancient artifact." },
    { id: "artifact_shard", name: "Artifact Shard", description: "A mystical shard retaining remnant power." },
    { id: "brimstone", name: "Brimstone", description: "Volcanic rock infused with hellfire." },
    { id: "demon_bone", name: "Demon Bone", description: "The skeletal remains of a slain demon." },
    { id: "hellfire_crystal", name: "Hellfire Crystal", description: "A crystal formed within demonic flame." },
    { id: "soul_gem", name: "Soul Gem", description: "A gem containing a trapped soul." },
  ],
  pets: [
    { id: "fire", name: "Fire Pet", description: "A pet infused with fire elemental energy." },
    { id: "water", name: "Water Pet", description: "A pet infused with water elemental energy." },
    { id: "earth", name: "Earth Pet", description: "A pet infused with earth elemental energy." },
    { id: "wind", name: "Wind Pet", description: "A swift pet infused with wind energy." },
    { id: "lightning", name: "Lightning Pet", description: "A pet crackling with electric energy." },
    { id: "ice", name: "Ice Pet", description: "A pet attuned to icy elemental forces." },
    { id: "nature", name: "Nature Pet", description: "A pet in harmony with the natural world." },
    { id: "dark", name: "Dark Pet", description: "A pet shrouded in shadow energy." },
    { id: "light", name: "Light Pet", description: "A pet radiating holy light energy." },
    { id: "arcane", name: "Arcane Pet", description: "A pet infused with raw arcane magic." },
    { id: "void", name: "Void Pet", description: "A pet that phases between dimensions." },
    { id: "mind", name: "Mind Pet", description: "A pet with powerful psychic abilities." },
    { id: "soul", name: "Soul Pet", description: "A pet bound to soul energy." },
    { id: "aether", name: "Aether Pet", description: "A rare pet infused with pure Aether." },
  ],
  spells: [
  ...
  zones: [
    ...
    { id: "mystic_tower", name: "Mystic Tower", description: "A towering structure of arcane knowledge and deadly floors." },
    { id: "mountain_caverns", name: "Mountain Caverns", description: "Deep caverns teeming with mineral wealth and danger." },
    { id: "ancient_ruins", name: "Ancient Ruins", description: "Remnants of a lost civilization, filled with old magic." },
    { id: "research_lab", name: "Research Lab", description: "A facility where scholars study elemental phenomena." },
    { id: "pet_training", name: "Pet Training Grounds", description: "A sanctuary where bonds between tamers and beasts are forged." },
    { id: "ruby_mines", name: "Ruby Mines", description: "Precious gemstone veins deep beneath the earth." },
    { id: "enchanted_forest", name: "Enchanted Forest", description: "A magical woodland alive with ancient Nature energy." },
    { id: "battle_arena", name: "Battle Arena", description: "A grand colosseum where warriors prove their strength." },
    { id: "crystal_lake", name: "Crystal Lake", description: "A serene lake with crystalline waters and rare fish." },
    { id: "coastal_village", name: "Coastal Village", description: "A fishing village on the edge of the ocean." },
    { id: "hell_zone", name: "Hell Zone", description: "The most dangerous PvP battleground in the realm." },
  ],
};

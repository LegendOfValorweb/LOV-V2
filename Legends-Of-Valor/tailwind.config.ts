  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        tier: {
          normal: "hsl(var(--tier-normal) / <alpha-value>)",
          "super-rare": "hsl(var(--tier-super-rare) / <alpha-value>)",
          x: "hsl(var(--tier-x) / <alpha-value>)",
          umr: "hsl(var(--tier-umr) / <alpha-value>)",
          ssumr: "hsl(var(--tier-ssumr) / <alpha-value>)",
          divine: "hsl(var(--tier-divine) / <alpha-value>)",
          journeyman: "hsl(var(--tier-journeyman) / <alpha-value>)",
          expert: "hsl(var(--tier-expert) / <alpha-value>)",
          master: "hsl(var(--tier-master) / <alpha-value>)",
          grandmaster: "hsl(var(--tier-grandmaster) / <alpha-value>)",
          legend: "hsl(var(--tier-legend) / <alpha-value>)",
          elite: "hsl(var(--tier-elite) / <alpha-value>)",
        },
        stat: {
          str: "hsl(var(--stat-str) / <alpha-value>)",
          int: "hsl(var(--stat-int) / <alpha-value>)",
          spd: "hsl(var(--stat-spd) / <alpha-value>)",
          luck: "hsl(var(--stat-luck) / <alpha-value>)",
        },
      },
      fontFamily: {
        sans: ["var(--font-sans)"],
